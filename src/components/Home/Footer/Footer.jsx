      ...
      <div className="section">
        <div className="flex justify-around">
          <div className="w-[564px]">
            <h1 className="font-Poppins font-semibold text-[32px] leading-[48px] uppercase text-white ">
              Subscribe to our newsletters for live updates
            </h1>
            <p className="font-Poppins font-light text-[20px] leading-[30px] text-white ">
          ...
          <div className="w-[440px]">
            <input
              type={"email"}
              className="w-full bg-[#7A7A7A] py-[17px] font-Open Sans font-semibold text-[26px] leading-[39px] rounded-[5px] text-white pl-[10px] required:border-red-500"
              placeholder="Email"
            />
            <div className="mt-[53px] flex">
              <input type={"checkbox"} className="w-[32px] h-[32px]" />
              <p className="ml-[28px] text-white w-[480px]">
                By clicking subscribe, I agree to receive newsletters, marketing
                communications, updates, special offers (including partner
                offers), and other information from BET and the Paramount family
                of companies.
              </p>
            </div>
