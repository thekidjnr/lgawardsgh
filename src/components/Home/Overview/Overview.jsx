  ...
  return (
    <div className="flex h-fit bg-[#1E1E1E] pb-[67px] justify-around ">
      <div className=" text-white mt-[85px] w-[605px] ">
        <h1 className="font-Open Sans font-bold text-[60px] leading-[82px] ">
          GENERAL OVERVIEW
        </h1>
        <p className=" mt-[14px]  text-[22px] font-medium text-justify ">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis
          commodo orci lectus elementum platea malesuada aliquet eu. Lectus id
          arcu, libero, ipsum neque laoreet egestas. Ultrices phasellus nisl ut
          aliquam volutpat erat tempor habitasse. Egestas sit consectetur
        ...
        <p className="  mt-[20px] text-[20px] text-end leading-[30px] font-light italic ">
